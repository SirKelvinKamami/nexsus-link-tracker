...
Route::get('/studio/projects', [ProjectController::class, 'index'])->name('projects.index');
Route::get('/studio/projects/create', [ProjectController::class, 'create'])->name('projects.create');
Route::post('/studio/projects', [ProjectController::class, 'store'])->name('projects.store');
Route::get('/studio/projects/{id}/edit', [ProjectController::class, 'edit'])->name('projects.edit');
Route::put('/studio/projects/{id}', [ProjectController::class, 'update'])->name('projects.update');
