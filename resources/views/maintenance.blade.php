...
<div class="containerr" style="">
      <div class="column">
        ...
        <img alt="avatar" src="{{ asset('assets/Nexsus Tracker/images/'.findFile('avatar')) }}" width="auto" height="200px">
        @else
        <div class="logo-container">
           <img src="{{ asset('assets/Nexsus Tracker/images/logo.svg') }}" alt="Logo" style="width:200px; height:200px;">
        </div>
        @endif
