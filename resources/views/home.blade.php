...
<!--#### BEGIN Meta Tags social media preview images  ####-->
  <!-- This shows a preview for title, description and avatar image of users profiles if shared on social media sites -->
    ...
    <meta property="og:image" content="{{ asset('assets/nexsus/images/'.findFile('avatar')) }}">
    @else
    ...
    @if(file_exists(base_path("assets/nexsus/images/").findFile('avatar')))
    <meta name="twitter:image" content="{{ asset('assets/nexsus/images/'.findFile('avatar')) }}">
    @else
            ...
            <div class="card card-transparent auth-card shadow-none d-flex mb-0">
              <div class="card-body justify-content-center text-center">
                ...
                <div class="logo-container fadein">
                  <img src="{{ asset('assets/nexsus/images/logo-animated.svg') }}" alt="Logo" style="width:150px; height:150px;">
                </div>
                @endif
            ...
            <div class="footer-body">
                ...
                <div class="right-panel">
                  ...
                  @if(env('DISPLAY_CREDIT_FOOTER') === true)
                    ...
                    </span> {{__('messages.by')}} <a href="#" target="_blank" style="opacity: 0.5; font-size: 0.85em;">Powered by Nexsus Tracker</a>.
                  @endif
                </div>
            </div>
        </footer>
