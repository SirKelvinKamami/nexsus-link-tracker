                  ...
                  <div class="col-sm-12">  
                    ...
                    <form action="{{ route('themeBackground') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group col-lg-8">
                            ...
                            <img class="bd-placeholder-img figure-img img-fluid rounded" src="@if(file_exists(base_path('assets/img/background-img/'.findBackground(Auth::user()->id)))){{url('assets//img/background-img/'.findBackground(Auth::user()->id))}}@else{{url('/assets/Nexsus Tracker/images/themes/no-preview.png')}}@endif"><br>
                  ...
                  <div class="col-sm-12">  
                    ...
                    <form action="{{ route('editTheme') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="d-flex flex-column flex-md-row align-items-md-center">
                            ...
                            <button class="btn btn-info download-themes" title="Download more themes"><a href="https://nexsustracker.org/themes/" target="_blank" class="text-white">{{__('messages.Download themes')}}</a></button>
                          </div>
                    </form>
                    </details>
                    </div>
                           ...
                           <div class="card-body pb-0">
                            <a style="cursor:pointer;" onclick="setTheme('default')">
                              <div class="d-flex justify-content-between">
                                 <div>
                                    <img draggable="false" class="bd-placeholder-img bd-placeholder-img-lg img-fluid" src="{{url('assets/Nexsus Tracker/images/themes/default.png')}}">
                                 </div>
                              </div>
