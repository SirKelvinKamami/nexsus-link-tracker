    ...
    @php
        $notifications = [
            ...
            [
                ...
                'title' => __('messages.Enjoying Nexsus?'),
...
notification('hide-star-notification', 'modal-star', __('messages.Support Nexsus'), ''.__('messages.support.msg1').' <a target="_blank" href="https://github.com/SirKelvinKamami/nexsus-link-tracker">'.__('messages.support.msg2').'</a>. '.__('messages.support.msg3').'<br><br>'.__('messages.support.msg4').' <a target="_blank" href="https://nexsus-link-tracker.onrender.com">'.__('messages.support.msg5').'<br><br>'.__('messages.support.msg6').'');
@endphp @endpush
