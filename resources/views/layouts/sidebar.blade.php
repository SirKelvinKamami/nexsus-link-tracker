        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(2) == 'analytics' ? 'active' : ''}}" href="{{ url('/studio/analytics') }}">
                            <i class="icon">
                                 <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2 12C2 6.48 6.48 2 12 2s10 4.48 10 10-4.48 10-10 10S2 17.52 2 12zm2 0c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8-8 3.58-8 8zm6-1v8h2v-8H10zm4-2v10h2V9h-2z" fill="currentColor"/>
                                </svg>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(2) == 'documents' ? 'active' : ''}}" href="{{ url('/studio/documents') }}">
                            <i class="icon">
                                 <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM16 18H8V16H16V18ZM16 14H8V12H16V14ZM13 9V3.5L18.5 9H13Z" fill="currentColor"/>
                                </svg>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(2) == 'landing-pages' ? 'active' : ''}}" href="{{ url('/studio/landing-pages') }}">
                            <i class="icon">
                                 <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM5 5H19V19H5V5ZM7 7H17V9H7V7ZM7 11H17V13H7V11ZM7 15H12V17H7V15Z" fill="currentColor"/>
                                </svg>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(2) == 'projects' ? 'active' : ''}}" href="{{ url('/studio/projects') }}">
                            <i class="icon">
                                 <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3 3C3 1.89543 3.89543 1 5 1H19C20.1046 1 21 1.89543 21 3V21C21 22.1046 20.1046 23 19 23H5C3.89543 23 3 22.1046 3 21V3ZM5 3H19V21H5V3ZM7 7H17V9H7V7ZM7 11H17V13H7V11ZM7 15H12V17H7V15Z" fill="currentColor"/>
                                </svg>
                            </i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(2) == 'webhooks' ? 'active' : ''}}" href="{{ url('/studio/webhooks') }}">
                            <i class="icon">
                                 <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Webhooks</span>
                        </a>
                    </li>
                    <li class="nav-item">
          ...
          <div class="footer-body">
              ...
              <div class="right-panel">
                ...
                @if(env('DISPLAY_CREDIT_FOOTER') === true)
                  ...
                  </span> {{__('messages.by')}} <a href="https://nexsus-link-tracker.onrender.com" target="_blank">Nexsus Tracker</a>.
                @endif
              </div>
          </div>
      </footer>
