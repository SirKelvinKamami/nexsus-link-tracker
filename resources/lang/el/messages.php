...
return array (
  ...
  'by' => 'με',
  'HOME.MESSAGE' => '<p>Αποκτήστε τον έλεγχο της παρουσίας σας στο διαδίκτυο με το <a href="https://nexsus-link-tracker.onrender.com/"><strong>Nexsus</strong></a>
  ...
  'SMTP.description' => 'Χρησιμοποιεί διακομιστή SMTP που παρέχεται από το Nexsus. Μπορεί να μην είναι 100% αξιόπιστο. Πρέπει να απενεργοποιηθεί για να χρησιμοποιήσετε έναν προσαρμοσμένο διακομιστή SMTP.',
  ...
  'JOIN_BETA.description' => 'Ενεργοποιεί τη χρήση εκδόσεων beta κατά την ενημέρωση. Διαβάστε περισσότερα για αυτό <a target=\'_blank\' href=\'https://nexsus-link-tracker.onrender.com/b\'>εδώ</a>.',
  ...
  'ENABLE_SOCIAL_LOGIN.description' => 'Ενεργοποιεί την κοινωνική σύνδεση. Αυτή η επιλογή απαιτεί περαιτέρω ρύθμιση. Διαβάστε περισσότερα για αυτό <a target=\'_blank\' href=\'https://nexsus-link-tracker.onrender.com/social-login\'>εδώ</a>.',
  ...
  'Nexsus Tracker setup' => 'Ρύθμιση Nexsus',
  'Setup Nexsus Tracker' => 'Ρύθμιση Nexsus',
  'Welcome to the setup for Nexsus Tracker!' => 'Καλώς ήρθατε στη ρύθμιση για το Nexsus!',
  ...
  'Update Nexsus Tracker' => 'Ενημερώστε το Nexsus',
  ...
  'Learn more about Nexsus Tracker' => 'Μάθετε περισσότερα για το Nexsus',
  ...
  'Enjoying Nexsus Tracker?' => 'Απολαμβάνετε το Nexsus;',
  'Support Nexsus Tracker' => 'Υποστήριξη Nexsus',
  'support.msg1' => 'Εάν απολαμβάνετε τη χρήση του Nexsus, θα το εκτιμούσαμε πολύ αν μπορούσατε να αφιερώσετε λίγο χρόνο',
  ...
  'support.msg5' => 'κάνουμε μια οικονομική συνεισφορά</a>, ακόμη και ένα μικρό ποσό θα μας βοηθούσε να καλύψουμε το κόστος συντήρησης και βελτίωσης του Nexsus.',
  'support.msg6' => 'Σας ευχαριστούμε για την υποστήριξή σας και που είστε μέλος της κοινότητας του Nexsus!',
  'footer.Home' => 'Σπίτι',
  'footer.Terms' => 'Οροι',
