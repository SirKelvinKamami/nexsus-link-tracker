...
return array (
  ...
  'by' => 'от',
  'HOME.MESSAGE' => '<p>Поемете контрол над онлайн присъствието си с <a href="https://nexsus-link-tracker.onrender.com/"><strong>Nexsus</strong></a>
  ...
  'SMTP.description' => 'Използва SMTP сървър, предоставен от Nexsus. Може да не е 100% надежден. Трябва да се деактивира, за да се използва персонализиран SMTP сървър.',
  ...
  'JOIN_BETA.description' => 'Позволява използването на бета версии при актуализиране. Прочетете повече за това <a target=\'_blank\' href=\'https://nexsus-link-tracker.onrender.com/b\'>тук</a>.',
  ...
  'ENABLE_SOCIAL_LOGIN.description' => 'Позволява социално влизане. Тази опция изисква допълнителна настройка. Прочетете повече за това <a target=\'_blank\' href=\'https://nexsus-link-tracker.onrender.com/social-login\'>тук</a>.',
  ...
  'Nexsus Tracker setup' => 'Настройка на Nexsus',
  'Setup Nexsus Tracker' => 'Настройте Nexsus',
  'Welcome to the setup for Nexsus Tracker!' => 'Добре дошли в настройката за Nexsus!',
  ...
  'Update Nexsus Tracker' => 'Актуализирайте Nexsus',
  ...
  'Learn more about Nexsus Tracker' => 'Научете повече за Nexsus',
  ...
  'Enjoying Nexsus Tracker?' => 'Радвате ли се на Nexsus?',
  'Support Nexsus Tracker' => 'Поддръжка на Nexsus',
  'support.msg1' => 'Ако обичате да използвате Nexsus, ще сме много благодарни, ако можете да отделите малко време',
  ...
  'support.msg5' => 'направите финансов принос</a>, дори малка сума ще ни помогне да покрием разходите за поддръжка и подобряване на Nexsus.',
  'support.msg6' => 'Благодарим ви за подкрепата и за това, че сте част от общността на Nexsus!',
  'footer.Home' => 'Начало',
