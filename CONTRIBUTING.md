# Contributing to Nexsus Tracker
...
```
5. Move the folder into a local web server (make sure you double-check the [requirements](https://nexsustracker.org/docs/d/installation-requirements/)).
